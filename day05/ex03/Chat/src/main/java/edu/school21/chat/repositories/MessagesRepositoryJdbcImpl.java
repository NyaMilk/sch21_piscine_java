...
public class MessagesRepositoryJdbcImpl implements MessagesRepository {
    ...
    public void update(Message message) throws NotSavedSubEntityException {
        ...
        try {
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("UPDATE Messages SET author = ?, chatRoom = ?, message = ?, createdAt = ? WHERE id = ?");
            ...
            if (result == 0) {
                throw new NotSavedSubEntityException("There is no changes in database!");
            }
